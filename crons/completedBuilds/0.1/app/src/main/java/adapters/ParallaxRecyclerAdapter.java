...
public class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setParallaxHeader(ImageView header, final RecyclerView view) {
        mRecyclerView = view;
        final ImageView mHeader = header;
...
//                if (mHeader != null) {
//                   Log.d("sunninCafe","header is not null");
//                    //mHeader.setTranslationY(1);
//                   //translateHeader(-mHeader.getTop());
////                    if (holder != null)
